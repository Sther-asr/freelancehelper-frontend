...
const AlertModalInfoTareas = ({onPress, informacion, colorBtnOcultar, textBtn, titulo, colorFondoModal, altura}) =>{
    return (
        <View style={[StylesModal.container,{backgroundColor: (colorFondoModal === undefined ? '#AAAAAA50' : colorFondoModal)}]}>
            <View style={[StylesModal.containerCuerpo,{height:(altura===undefined? StylesModal.containerCuerpo.height : altura)}]}>
                <TouchableOpacity
                ...
                <View style={[StylesModal.cuerpoInformacion]}>
                    ...
                    <Text style={[StylesModal.textoInfo]}>{informacion.idActividad === undefined ? 'Recordatorio': 'Actividad'}</Text> 
                    <Text style={[StylesModal.subtitulo]}>Descripción:</Text>
                    <Text style={[StylesModal.textoInfo]}>{informacion.descripcion}</Text>
                    ...
                    <Text style={[StylesModal.textoInfo]}>{informacion.fechaInicio}</Text> 
