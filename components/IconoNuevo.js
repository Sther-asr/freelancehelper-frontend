    ...
    return(
        <ImageBackground style={[StylesHome.botonNueva]} source={require('../assets/icons/plus.png')}>
            ...
            >
                ...
                <Divider />
                <Menu.Item onPress={() => { closeMenu(); navegar.navigation.navigate('OrganizadorStack')}} title="Proyecto" icon={() => { return (<Image source={require('../assets/icons/Crear-Proyecto.png')} style={{ width: 35, height: 25 }} />) }} />
                <Divider />
