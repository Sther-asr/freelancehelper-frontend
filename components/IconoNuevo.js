    ...
    return(
        <ImageBackground style={[StylesHome.botonNueva]} source={require('../assets/icons/plus.png')}>
            ...
            >
                ...
                <Divider />
                <Menu.Item onPress={() => { closeMenu(); navegar.navigation.navigate('ProyectoStack')}} title="Proyecto" icon={() => { return (<Image source={require('../assets/icons/Crear-Proyecto.png')} style={{ width: 35, height: 25 }} />) }} />
                <Divider />
                ...
                <Divider />
                <Menu.Item onPress={() => { closeMenu(); navegar.navigation.navigate('RecordatorioStack')}} title="Recordatorio" icon={() => { return (<Image source={require('../assets/icons/Crear-Recordatorio.png')} style={{ width: 27, height: 30, marginLeft: 4 }} />) }} />
                <Divider />
            </Menu>
